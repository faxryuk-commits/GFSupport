...
const PLANS: Record<PlanType, PlanConfig> = {
  ...
  business: {
    ...
    navPaths: ['/overview', '/chats', '/channels', '/cases', '/onboarding', '/commitments', '/analytics', '/benchmarks', '/insights-chat', '/ai-agent', '/routing', '/knowledge', '/broadcast', '/settings', '/system-map', '/sales', '/sales/queue', '/sales/deals', '/sales/leads', '/sales/accounts', '/sales/reports', '/sales/assistant', '/sales/settings'],
  },
  enterprise: {
    name: 'Enterprise',
    price: 199,
