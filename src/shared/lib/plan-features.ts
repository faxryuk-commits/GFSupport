...
const PLANS: Record<PlanType, PlanConfig> = {
  ...
  business: {
    ...
    navPaths: ['/me', '/overview', '/chats', '/channels', '/cases', '/onboarding', '/commitments', '/analytics', '/benchmarks', '/insights-chat', '/ai-agent', '/routing', '/knowledge', '/broadcast', '/settings', '/system-map', '/sales', '/sales/queue', '/sales/deals', '/sales/leads', '/sales/accounts', '/sales/reports', '/sales/funnel', '/sales/assistant', '/sales/settings', '/sales/chats', '/sales/comments'],
  },
  enterprise: {
    name: 'Enterprise',
    price: 199,
