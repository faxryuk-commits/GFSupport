 ...
 *
 * Ниже пульса — досье: каналы заказов долями, что подключено (POS,
 * агрегаторы, доставка, модули), сигналы допродажи по правилам с ценой из
 * прайса и сценарий разговора из них. «В задачу» кладёт сигнал в задачи
 * аккаунта — сейлз открывает карточку перед звонком и уходит с планом.
 */
