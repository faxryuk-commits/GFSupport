...
const DEFAULTS: Record<string, string[]> = {
  country: ['Узбекистан', 'Казахстан', 'Азербайджан', 'Грузия', 'ОАЭ'],
  city: ['Ташкент', 'Ташкентская область', 'Самарканд', 'Фергана', 'Андижан', 'Бухара',
    'Наманган', 'Кашкадарья', 'Хорезм', 'Джизак', 'Навои', 'Сурхандарья', 'Сырдарья',
    'Каракалпакстан', 'Алматы', 'Астана', 'Шымкент', 'Караганда', 'Актобе', 'Тараз'],
