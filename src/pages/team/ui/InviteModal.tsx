        ...
        {!url ? (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2 bg-gradient-to-br from-[#3b82f6] to-[#2563eb] text-white shadow-[0_3px_10px_rgba(37,99,235,0.22)] rounded-lg hover:brightness-[1.04] hover:shadow-[0_5px_16px_rgba(37,99,235,0.34)] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
