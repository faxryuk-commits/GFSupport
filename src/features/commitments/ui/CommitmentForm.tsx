    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-[#e8edf3] p-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex-1 px-4 py-2 bg-gradient-to-br from-[#3b82f6] to-[#2563eb] text-white shadow-[0_3px_10px_rgba(37,99,235,0.22)] rounded-lg hover:brightness-[1.04] hover:shadow-[0_5px_16px_rgba(37,99,235,0.34)] disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {loading ? (
