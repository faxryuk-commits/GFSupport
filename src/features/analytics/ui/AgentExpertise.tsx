    ...
    <div className="bg-white rounded-xl border border-slate-200 p-4">
      ...
      <div className="space-y-2">
        {data.map(agent => {
          ...
          return (
            <div key={agent.name} className="border border-slate-100 rounded-lg">
              <button
