 ...
 *
 * Живёт в обзоре, а не внутри кейсов: раздел кейсов — рабочее место, где
 * разбирают очередь, и итог недели там ищут в последнюю очередь. Обзор —
 * то место, куда заходят с вопросом «как у нас дела».
 *
 * Пять ответов, каждый с опорой: цифра рядом с прошлым периодом, время
 * решения медианой, а не средним, темы — из текста обращений.
 */
