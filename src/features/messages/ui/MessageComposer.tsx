...
export function MessageComposer({ 
  ...
  return (
    <div className="border-t border-[#e8edf3] bg-white">
      {/* Reply preview */}
      {replyTo && (
        <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 border-b border-[#e8edf3]">
      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-2 p-4">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            rows={1}
            className="w-full px-4 py-2 bg-slate-50 border border-[#e8edf3] rounded-2xl resize-none
        ...
        <button
          ...
          className="p-2 bg-gradient-to-br from-[#3b82f6] to-[#2563eb] text-white shadow-[0_3px_10px_rgba(37,99,235,0.22)] rounded-lg hover:brightness-[1.04] hover:shadow-[0_5px_16px_rgba(37,99,235,0.34)] transition-all
