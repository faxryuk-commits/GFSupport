...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  slate: 'bg-slate-50 border-[#e8edf3] text-slate-700',
}
      ...
      <div className="bg-white rounded-xl border border-[#e8edf3] p-6">
                ...
                return (
                  <button
                    ...
                    className={`px-2.5 py-1.5 rounded-md text-xs border transition-all ${
                      exists
                        ? 'bg-slate-100 text-slate-400 border-[#e8edf3] cursor-not-allowed'
          ...
          <div className="flex gap-3 mb-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 border border-[#e8edf3] rounded-lg text-sm"
              />
            </div>
            <div className="relative">
              ...
              <select
                ...
                className="pl-9 pr-8 py-2 border border-[#e8edf3] rounded-lg text-sm appearance-none bg-white"
              >
        ...
        <div className="space-y-3">
          {groupedRules.map(group => {
            ...
            return (
              <div key={group.id} className="border border-[#e8edf3] rounded-lg overflow-hidden">
                <button
                  onClick={() => {
        ...
        {testResult && (
          <div className="mt-4 bg-slate-50 rounded-lg p-4 space-y-2">
            ...
            {testResult.replyText && (
              <p className="text-sm text-slate-800 bg-white rounded-lg p-3 border border-[#e8edf3]">
                {testResult.replyText}
              </p>
            )}
