...
const payload = {
  ...
  weekly: weekly.slice(0, -1).map(r => ({ w: r.w, n: Number(r.n) })),
  channels: channels.map(r => ({ m: r.m, agg: Number(r.agg), own: Number(r.own), pickup: Number(r.pickup), hall: Number(r.hall) })),
