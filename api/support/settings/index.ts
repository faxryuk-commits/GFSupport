...
const DEFAULT_SETTINGS = {
  ...
  sales_group_chat_id: '',
  // Источники, которые в группу не носим: их туда уже кладёт другой бот.
  // Через запятую, ключами источников. По умолчанию — сайт: заявки с него
  // публикует «Delever site leads»
  sales_group_skip_sources: 'site',
